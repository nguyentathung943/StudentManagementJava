...
public class ResetPasswordForm extends JFrame {
	...
	private Image usr = new ImageIcon(ResetPasswordForm.class.getResource("/icon/username.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	private Image pass = new ImageIcon(ResetPasswordForm.class.getResource("/icon/password.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
	private Image Key = new ImageIcon(ResetPasswordForm.class.getResource("/icon/Key.png")).getImage().getScaledInstance(30, 30, Image.SCALE_SMOOTH);
